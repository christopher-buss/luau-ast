...
export declare function setNodeOrigin<T extends luau.Node>(node: T, origin: luau.NodeOrigin): T;
export declare function create<T extends keyof luau.NodeByKind>(kind: T, fields: Omit<FilteredNodeByKind<T>, keyof luau.Node>): luau.NodeByKind[T];
...
export declare function string(value: string, quote?: luau.StringLiteral["quote"]): luau.StringLiteral;

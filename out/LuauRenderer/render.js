...
exports.renderASTWithPositions = exports.renderAST = exports.renderNode = exports.render = void 0;
...
function render(state, node) {
    return (0, Fragment_1.fragmentToString)(renderNode(state, node));
}
exports.render = render;
function renderNode(state, node) {
    return state.markNode(node, KIND_TO_RENDERER[node.kind](state, node));
}
...
function renderAST(ast) {
    ...
    return (0, Fragment_1.fragmentToString)((0, renderStatements_1.renderStatementsFragment)(state, ast));
}
exports.renderAST = renderAST;
function renderASTWithPositions(ast) {
    const state = new RenderState_1.RenderState(true);
    (0, solveTempIds_1.solveTempIds)(state, ast);
    return (0, Fragment_1.flattenFragment)((0, renderStatements_1.renderStatementsFragment)(state, ast));
}
exports.renderASTWithPositions = renderASTWithPositions;
